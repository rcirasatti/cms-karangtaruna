    ...
    <div class="container mx-auto px-4">
        ...
        <div class="max-w-6xl mx-auto -mt-32 mb-16 relative z-20">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <!-- WhatsApp Card -->
                @if($kontak->whatsapp)
                <a href="https://wa.me/{{ str_replace(['+', '-', ' '], '', $kontak->whatsapp) }}" target="_blank" 
                        ...
                        <div class="p-8 space-y-6">
                            ...
                            <div class="group">
                                <div class="flex items-start p-5 rounded-2xl transition-all duration-300 hover:bg-gradient-to-br hover:from-green-50 hover:to-green-100/50">
                                    ...
                                    <div class="ml-5 flex-1">
                                        <h3 class="font-bold text-gray-900 text-lg mb-2">WhatsApp</h3>
                                        <p class="text-gray-600 mb-3 font-medium">{{ $kontak->whatsapp }}</p>
                                        <a href="https://wa.me/{{ str_replace(['+', '-', ' '], '', $kontak->whatsapp) }}" target="_blank" 
                            ...
                            <div class="group">
                                <div class="flex items-start p-5 rounded-2xl transition-all duration-300 hover:bg-gradient-to-br hover:from-accent/50 hover:to-secondary/30">
                                    ...
                                    <div class="ml-5">
                                        <h3 class="font-bold text-gray-900 text-lg mb-2">Telepon</h3>
                                        <a href="tel:{{ $kontak->telepon }}" class="text-primary-600 hover:text-primary-700 font-semibold text-lg">{{ $kontak->telepon }}</a>
                                    </div>
                                </div>
                            </div>
                            @endif
                            ...
                            <div class="group">
                                <div class="flex items-start p-5 rounded-2xl transition-all duration-300 hover:bg-gradient-to-br hover:from-blue-50 hover:to-blue-100/50">
                                    ...
                                    <div class="ml-5">
                                        <h3 class="font-bold text-gray-900 text-lg mb-2">Email</h3>
                                        <a href="mailto:{{ $kontak->email }}" class="text-primary-600 hover:text-primary-700 font-medium break-all">{{ $kontak->email }}</a>
                                    </div>
                                </div>
                            </div>
                            @endif
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-gradient-to-br from-primary-700 to-primary-800 rounded-3xl shadow-xl overflow-hidden text-white">
                        ...
                        <div class="p-8">
                            ...
                            <div class="space-y-3">
                                @if($kontak->instagram)
                                <a href="https://instagram.com/{{ ltrim($kontak->instagram, '@') }}" target="_blank" 
                                   class="flex items-center p-4 bg-white/10 backdrop-blur-sm rounded-xl hover:bg-white/20 transition-all duration-300 group/social">
                                    ...
                                    <div class="ml-4 flex-1">
                                        ...
                                        <span class="text-xs text-primary-100">{{ $kontak->instagram }}</span>
                                    </div>
                                ...
                                @if($kontak->facebook)
                                <a href="https://facebook.com/{{ $kontak->facebook }}" target="_blank" 
                                   class="flex items-center p-4 bg-white/10 backdrop-blur-sm rounded-xl hover:bg-white/20 transition-all duration-300 group/social">
                                    ...
                                    <div class="ml-4 flex-1">
                                        ...
                                        <span class="text-xs text-primary-100">{{ $kontak->facebook }}</span>
                                    </div>
                                    <svg class="w-5 h-5 group-hover/social:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                    </svg>
                                ...
                                @if($kontak->twitter)
                                <a href="https://twitter.com/{{ ltrim($kontak->twitter, '@') }}" target="_blank" 
                                   class="flex items-center p-4 bg-white/10 backdrop-blur-sm rounded-xl hover:bg-white/20 transition-all duration-300 group/social">
                                    ...
                                    <div class="ml-4 flex-1">
                                        ...
                                        <span class="text-xs text-primary-100">{{ $kontak->twitter }}</span>
                                    </div>
                                    <svg class="w-5 h-5 group-hover/social:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                    </svg>
                                ...
                                @if($kontak->youtube)
                                <a href="https://youtube.com/{{ $kontak->youtube }}" target="_blank" 
                                   class="flex items-center p-4 bg-white/10 backdrop-blur-sm rounded-xl hover:bg-white/20 transition-all duration-300 group/social">
                                    ...
                                    <div class="ml-4 flex-1">
                                        ...
                                        <span class="text-xs text-primary-100">{{ $kontak->youtube }}</span>
                                    </div>
                                    <svg class="w-5 h-5 group-hover/social:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                    </svg>

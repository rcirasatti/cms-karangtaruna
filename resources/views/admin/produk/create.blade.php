        ...
        <form action="{{ route('admin.produk.store') }}" method="POST" enctype="multipart/form-data" data-validate="true">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-lg p-8 space-y-6">
                        ...
                        <div>
                            ...
                            <select id="kategori" name="kategori"
                                ...
                                <option value="Kerajinan" {{ old('kategori') === 'Kerajinan' ? 'selected' : '' }}>🎨
                                    Kerajinan</option>
                                <option value="Makanan" {{ old('kategori') === 'Makanan' ? 'selected' : '' }}>🍽️ Makanan
                                </option>
                                <option value="Minuman" {{ old('kategori') === 'Minuman' ? 'selected' : '' }}>🥤 Minuman
                                </option>
                                <option value="Elektronik" {{ old('kategori') === 'Elektronik' ? 'selected' : '' }}>📱
                                    Elektronik</option>
                                <option value="Kecantikan" {{ old('kategori') === 'Kecantikan' ? 'selected' : '' }}>💄
                                    Kecantikan</option>
                                <option value="Tanaman" {{ old('kategori') === 'Tanaman' ? 'selected' : '' }}>🌿 Tanaman
                                </option>
                        ...
                        <div>
                            ...
                            <input type="number" id="harga" name="harga" value="{{ old('harga') }}"
                                placeholder="Contoh: 150000" step="1" min="0"
                ...
                <div class="lg:col-span-1">
                    <!-- Upload Container -->
                    <div
                        class="bg-gradient-to-br from-primary-50 to-primary-100 rounded-2xl p-6 border-2 border-primary-200 sticky top-8 space-y-6">
                        <!-- Foto Utama Section -->
                        <div>
                            ...
                            <div x-data="{ previewUrl: '', fileName: '' }" class="space-y-4">
                                ...
                                <label class="relative block group">
                                    ...
                                    <div
                                        class="bg-white rounded-xl border-2 border-dashed border-primary-300 hover:border-primary-500 hover:bg-primary-50 p-6 text-center cursor-pointer transition duration-200">
                                        <svg class="w-10 h-10 mx-auto text-primary-500 mb-2" fill="none"
                                ...
                                <div x-show="previewUrl" x-cloak
                                    class="relative rounded-xl overflow-hidden border-2 border-primary-300">
                        ...
                        <div>
                            <h3 class="text-lg font-bold font-montserrat text-gray-800 mb-4 flex items-center">
                                <svg class="w-5 h-5 mr-2 text-primary-600" fill="currentColor" viewBox="0 0 20 20">
                                    <path
                                        d="M5 3a2 2 0 00-2 2v6h6V5a2 2 0 00-2-2H5zM15 3a2 2 0 00-2 2v6h6V5a2 2 0 00-2-2h-2zM5 13a2 2 0 00-2 2v2h6v-2a2 2 0 00-2-2H5zM15 13a2 2 0 00-2 2v2h6v-2a2 2 0 00-2-2h-2z">
                                    </path>
                                </svg>
                                Galeri Produk
                            </h3>
                            ...
                            <div x-data="{ galleries: [] }" class="space-y-4">
                                ...
                                <label class="relative block group">
                                    <input type="file" name="galeri[]"
                                       ...
                                       "
                                        multiple accept="image/*" class="hidden" data-max-size="5242880"
                                    ...
                                    <div
                                        ...
                                        <p class="text-xs text-red-500 mt-1 font-medium">⚠️ Maksimal per file: 5 MB |
                                            Total: 50 MB</p>
                                        <p x-show="galleries.length > 0" x-cloak
                                            class="text-xs text-primary-600 mt-2 font-semibold">
                        ...
                        <div class="bg-white/70 rounded-lg p-3.5 space-y-2 border border-primary-200">
                            ...
                            <ul class="text-xs text-gray-600 space-y-1.5">
                                <li class="flex items-start">
                                    <svg class="w-3.5 h-3.5 mr-2 text-primary-600 flex-shrink-0 mt-0.5"
                        ...
                        <div class="bg-amber-50 rounded-lg p-3.5 border-l-4 border-amber-400">
                            <p class="text-xs text-amber-800 font-poppins">
                                <span class="font-semibold">💡 Tips:</span> Gunakan gambar berkualitas tinggi untuk hasil
                                tampilan terbaik.
                            </p>
                        </div>
                    </div>

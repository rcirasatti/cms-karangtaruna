...
@section('page-title', 'Edit Data Pengurus')
...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-primary-600 to-primary-700 rounded-2xl shadow-lg p-8 text-white">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold font-montserrat mb-2">Edit Pengurus</h1>
                <p class="text-primary-100">Ubah informasi pengurus yang ada</p>
            </div>
    ...
    <!-- Form Card -->
    <form action="{{ route('admin.kepengurusan.update', $pengurus->id) }}" method="POST" enctype="multipart/form-data" data-validate="true">
        @csrf
        @method('PUT')
                ...
                <div class="bg-white rounded-2xl shadow-lg p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="tugas"
                                  ...
                                  class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-100 transition font-poppins resize-none @error('tugas') border-red-500 @enderror">{{ old('tugas', $pengurus->tugas) }}</textarea>
                        @error('tugas')
                            <p class="text-red-500 text-xs mt-1.5">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="border-t pt-6">
                        ...
                        <textarea id="profil_singkat"
                                  ...
                                  class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-100 transition font-poppins resize-none @error('profil_singkat') border-red-500 @enderror">{{ old('profil_singkat', $pengurus->profil_singkat) }}</textarea>
                            ...
                            <div class="flex items-center space-x-4">
                                <label class="flex items-center cursor-pointer">
                                    <input type="radio"
                                           name="is_tokoh_utama"
                                           value="1"
                                           {{ old('is_tokoh_utama', $pengurus->is_tokoh_utama) == '1' ? 'checked' : '' }}
                                ...
                                <label class="flex items-center cursor-pointer">
                                    <input type="radio"
                                           name="is_tokoh_utama"
                                           value="0"
                                           {{ old('is_tokoh_utama', $pengurus->is_tokoh_utama) == '0' ? 'checked' : '' }}
                                           class="w-4 h-4 text-primary-600 focus:ring-primary-500">
            ...
            <div class="lg:col-span-1">
                ...
                <div class="bg-gradient-to-br from-primary-50 to-primary-100 rounded-2xl p-6 border-2 border-primary-200 sticky top-8 space-y-6">
                    ...
                    <div>
                        ...
                        @if($pengurus->foto)
                            <div class="mb-4">
                                <p class="text-xs text-gray-600 mb-2 font-semibold">Foto Saat Ini:</p>
                                <div class="relative rounded-xl overflow-hidden border-2 border-primary-300">

        ...
        <ul class="space-y-2">
            ...
            <li>
                <a href="{{ route('admin.visi-misi.index') }}" 
                   class="flex items-center px-4 py-3 rounded-xl transition duration-200 {{ request()->routeIs('admin.visi-misi.*') ? 'bg-gradient-to-r from-primary-600 to-primary-700 text-white shadow-lg' : 'hover:bg-primary-800/50' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                <a href="{{ route('admin.kegiatan.index') }}" 
                   class="flex items-center px-4 py-3 rounded-xl transition duration-200 {{ request()->routeIs('admin.kegiatan.*') ? 'bg-gradient-to-r from-primary-600 to-primary-700 text-white shadow-lg' : 'hover:bg-primary-800/50' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">

                ...
                <div class="bg-white rounded-2xl shadow-lg p-8 space-y-6">
                    ...
                    <div class="border-t pt-6">
                        ...
                        <textarea id="deskripsi"
                                  ...
                                  class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-100 transition font-poppins resize-y @error('deskripsi') border-red-500 @enderror">{{ old('deskripsi', $berita->deskripsi) }}</textarea>

        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="hidden md:block">
                    ...
                    <p class="text-xs text-primary-200 font-poppins"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center space-x-4">
            ...
            <div class="relative" x-data="{ open: false }">
                <button @click="open = !open" 
                    ...
                    <div class="w-9 h-9 bg-gradient-to-r from-accent to-secondary rounded-full flex items-center justify-center text-primary-800 font-bold shadow-lg">
                        <?php echo e(strtoupper(substr(Auth::user()->name, 0, 1))); ?>

                    </div>
                    <div class="hidden md:block text-left">
                        <p class="text-sm font-semibold font-poppins"><?php echo e(Auth::user()->name); ?></p>
                ...
                <div x-show="open" 
                    ...
                    <a href="#" class="flex items-center px-4 py-2.5 text-sm text-gray-700 hover:bg-primary-50 transition">
...
<?php /**PATH D:\Magang\cms-karangtaruna\resources\views/admin/layouts/navbar.blade.php ENDPATH**/ ?>